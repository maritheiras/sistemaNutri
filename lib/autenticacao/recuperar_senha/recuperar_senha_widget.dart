...
class _RecuperarSenhaWidgetState extends State<RecuperarSenhaWidget> {
  ...
  void initState() {
    ...
    _model.enderecoEmailTextController ??= TextEditingController();
                        ...
                        image: DecorationImage(
                          ...
                          image: Image.asset(
                            Theme.of(context).brightness == Brightness.dark
                                ? 'assets/images/Reset_password_(1).gif'
                                : 'assets/images/Reset_password.gif',
                          ).image,
                        ),
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .enderecoEmailTextController,
                                          focusNode:
                                              _model.enderecoEmailFocusNode,
                                          autofocus: false,
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          // Enviar link para e-mail informado
                                          if (_model.enderecoEmailTextController
                                              .text.isEmpty) {
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'Link para resetar senha enviado para o e-mail informado com sucesso!',
                                                style: TextStyle(
